...
import { PayoutThreshold } from "./payment-threshold";
...
export function Demo() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-between gap-6 bg-muted p-4 sm:p-6 lg:p-12 dark:bg-background">
